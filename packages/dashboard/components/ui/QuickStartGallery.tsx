 ...
 */
export const QuickStartGallery: React.FC<Props> = ({ onOpenProject, onNavigate }) => {
...
const TemplateCard: React.FC<{ template: QuickStartTemplate; onClick: () => void; loading: boolean }> = ({ template, onClick, loading }) => {
  ...
  return (
    <button
      ...
      disabled={loading}
      className={clsx(
        "surface-secondary text-left transition-all group disabled:opacity-60",
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-3 type-meta tabular-nums">
