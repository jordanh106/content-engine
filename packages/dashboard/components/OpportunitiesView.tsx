          ...
          <div className="bg-surface-elevated border border-themed rounded-2xl p-4">
            ...
            <div className="space-y-2">
              <button
                ...
                disabled={produced || startProductionMutation.isPending}
                className={cn(
                  "w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-full text-xs font-semibold transition-colors",
                  produced
              ...
              <button
                onClick={onBack}
                className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-full text-xs font-semibold text-themed-secondary bg-surface-hover hover:bg-surface-hover transition-colors"
              >
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex flex-col items-end gap-1 shrink-0">
          <button
            ...
            className={cn(
              "flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-semibold transition-colors",
