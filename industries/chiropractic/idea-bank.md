...
Staging area for content ideas not yet scheduled. Ideas flow in from `/last30days`, `/viral-scout`, `/creator-analysis`, audience questions, and personal inspiration. When running `/content-planner`, check this file first before generating new ideas.

**Workflow:** Idea captured here -> Reviewed during planning -> Promoted to calendar -> Archived after scheduling

---

## Trending Ideas

Ideas from recent research or viral trends. Time-sensitive, schedule within 1-2 weeks.
...
Patterns or gaps spotted from creator analysis. Adapt to our voice, never copy.
...
Always relevant, not time-sensitive. Good for filling calendar gaps.

| Topic | Suggested Format | Hook Angle | Priority | Audience | Date Added |
|-------|-----------------|------------|----------|----------|------------|
| Posture self-check routine | C (Demo) | "30-second posture check you can do right now" | Medium | Adults | 2026-03-02 |
| What your sleeping position says about your spine | A (Explainer) | Statistic: "You spend 1/3 of your life in bed" | Medium | Adults | 2026-03-02 |
...
Ideas from patient questions, DMs, comments, or in-office conversations.
...
Behind-the-scenes, humor, personal brand content, experimental formats.
...
Move ideas here after they've been promoted to the calendar. Keep for reference.
